...
# hyperparam values to be tested
# "policy_learning_rate": [0.01, 0.002, 0.001, 0.0002, 0.0001]
# "critic_learning_rate": [0.01, 0.002, 0.001, 0.0002, 0.0001]
BIPEDAL_HPARAMS = {"tau": [1.0, 0.1, 0.01, 0.005, 0.003 ,0.002, 0.001]}
