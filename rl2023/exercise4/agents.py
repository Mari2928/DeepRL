...
class DDPG(Agent):
    ...
    def __init__(
        ...
        self.critic_optim = Adam(self.critic.parameters(), lr=critic_learning_rate, eps=1e-3)# weight_decay=0.01
    ...
    def update(self, batch: Transition) -> Dict[str, float]:
        ...
        **YOU MUST IMPLEMENT THIS FUNCTION FOR Q4**
        ...
        # Compute critic loss     
        Q_expected = self.critic(torch.cat((states, actions), 1))
        ...
        p_loss = -self.critic(torch.cat((states, actions_pred), 1)).mean()
        # Minimize the loss
